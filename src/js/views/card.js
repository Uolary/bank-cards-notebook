    ...
    return `
      <li class="card__item">
        <div class="card__header">
          ...
          <button class="card__remove-btn" data-id="${card.cardNumber}" aria-label="Remove a credit card">
